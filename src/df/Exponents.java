...
public class Exponents
{
	...
	public static void main(String[] args)
	{
		...
		//ConsolePrompts methods handle console prompts and exceptions 

		while(active)
		{
			inputArray = ConsolePrompts.promptStringArray("\nPlease enter an integer base and an integer exponent. Separate your inputs using commas.", 2);
			...
			System.out.printf("\n\t" + base + "^" + exponent + " = %,d\nThat's " + NumberNamer.nameNumber(power) + customRetort + ".\n\n", power);

			active = ConsolePrompts.promptRestart("Would you like to try again for another base and exponent?");
		}
	}
